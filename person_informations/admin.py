...
from .models import Information, ExpertiseLanguage, ExpertiseFramework, Portfolio, CarouselPortfolioImage, Form
...
class FormAdmin(admin.ModelAdmin):
    list_display = ["first_name", "name", "email", "create_at", "update_at"]
