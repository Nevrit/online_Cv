# Generated by Django 4.2.11 on 2024-03-21 15:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('person_informations', '0007_remove_expertiselanguage_image'),
    ]

    operations = [
        migrations.AddField(
            model_name='expertiseframework',
            name='icon',
            field=models.CharField(default=0, max_length=50, verbose_name="Classe de l'icône FontAwesome"),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='expertiseframework',
            name='name',
            field=models.CharField(default=0, max_length=30, verbose_name='Nom du langage'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='expertiseframework',
