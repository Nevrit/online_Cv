# Generated by Django 4.2.11 on 2024-03-21 15:02
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('person_informations', '0004_expertiseframework_expertiselanguage'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='expertiselanguage',
            options={'verbose_name': 'Langage Informatique', 'verbose_name_plural': 'Langage Informatique'},
        ),
        migrations.AlterModelOptions(
            name='information',
            options={'verbose_name': 'Information Personnelles'},
        ),
        migrations.AddField(
            model_name='expertiselanguage',
            name='image',
            field=models.ImageField(default=0, upload_to='language_image/'),
